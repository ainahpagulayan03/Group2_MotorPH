...
public class SignIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bg.add(LoginBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 330, -1, 30));
    ...
    private void LoginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginBtnActionPerformed
        ...
        String query = "SELECT * FROM motorphemployeedb.`motorphemployeedata-employeedetails` WHERE `Employee_no` = ? AND `Password` = ? ";
        ...
        else if(password.trim().equals("password"))
        {
            JOptionPane.showMessageDialog(null, "Enter Your Password", "Empty Password", 2);
                ...
                AdminPayroll admin = new AdminPayroll();
